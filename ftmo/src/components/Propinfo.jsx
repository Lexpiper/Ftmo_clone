const Propinfo = () => {
  return (
    <div className="flex flex-col md:flex-row items-center bg-[#f4f4f4]">
      ...
      <div className="md:w-1/2 px-10">
        <h3 className="leading-[1.2] text-[1.875rem] font-semibold font-poppins tracking-wider pb-10 ">
          Trade for Proprietary <br /> Trading Firm
        </h3>

        <p className="mb-[30px] text-[0.875rem] leading-[24px] text-[#555B6C] tracking-wider font-poppins">
        ...
        <p className="mb-[30px] text-[0.875rem] leading-[24px] text-[#555B6C] tracking-wider font-poppins">
          ...
          endeavour to financial independence.
        </p>
      </div>
    </div>
  );
